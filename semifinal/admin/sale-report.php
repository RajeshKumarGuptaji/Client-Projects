...
<section id="page-title">
   <div class="row">
      <div class="col-sm-8">
         <h1 class="mainTitle">Admin | Inner Stock Details</h1>
      </div>
      <ol class="breadcrumb">
         <li>
            <span>Admin</span>
...
<div class="container-fluid container-fullw bg-white">
   <div class="row">
      <div class="col-md-12">
         <h5 class="over-title margin-bottom-15">Manage <span class="text-bold">Inner Stock Details</span></h5>
         ...
         <table class="table table-hover" id="example">
            ...
            <tbody>
               <?php
                  $sql=mysqli_query($con,"SELECT `name`,`quantity`,`unit_first`,`unit_second`,`batch no`,`mfd`,`exp`,`unit_price`,`description`,`cmp`,`sale_date`,`tot_qty` FROM `inner_stock_dtl`");
                  $cnt=1;
